...
import com.guru.moviepagingtest.movie_details.play.Trailer;
...
import static com.guru.moviepagingtest.utils.HelperClass.getEntirePosterPathUrl;
...
public class MovieDetailsActivity extends DaggerAppCompatActivity {
    ...
    private String getMovieIdFromIntent() {
        return  (String) getIntent().getSerializableExtra("movieId");
    }
...
//        setTitle("Movie Details");
    ...
    private void playFirstTrailer(String movieId) {
